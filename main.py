...
from test2 import PossibilitiesTest
import tkinter
...
class Main:
    def __init__(self):
        ...
        self.poss_test = PossibilitiesTest()
    ...
    def touched(self, event):
        ...
        self.poss_test.check_king_state(self.matrix, self.turn)
        # self.poss_test.check_possibilities()
        ...
        if self.matrix[x][y] != 0:
            if self.matrix[x][y].side == self.turn:
                ...
                self.blockes = self.matrix[x][y].blocking_moves
                ...
                for i in range(len(self.blockes)):
                    self.canvas.create_oval(self.blockes[i][0]*50 + 20, self.blockes[i][1]*50 + 20, self.blockes[i][0]*50 + 30, self.blockes[i][1]*50 + 30, tag="oval", fill="green")
